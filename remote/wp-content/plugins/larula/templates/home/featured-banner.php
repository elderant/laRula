...
<div class="main-banner-section">
    ...
    <div class="additional-info overlay hidden">
      <div class="additional-info-container">
        ...
        <div class="price">
          <?php echo 'precio : ' . wc_price( $variation->get_price() );?>
        </div>
        <div class="estimated-hours">
          <?php echo 'Intensidad horaria : ' . $_object -> estimated_hours;?>
        </div>
        <div class="maximun-seats">
          <?php echo 'cupos : ' . $variation -> get_stock_quantity() . '/' . $_object -> maximun_seats . '<span style="color:red; padding-left:0.5rem; font-weight:bold;">SE DEBEN MOSTRAR LAS QUE NO TENGAN CUPOS?</span>';?>
        </div>
        <div class="variation-description">
          <?php echo $variation -> get_description();?>
        </div>
        <div class="parent-excerpt">
          <?php echo $parent -> get_short_description();?>
        </div>
